...
| ------------------------------------ | --------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `<TICKER>_processed.csv`             | Price + full indicator set per ticker         | `date`, `ticker`, `open`, `high`, `low`, `close`, `adj_close`, `volume`, `daily_return`, `log_return`, `is_outlier`, `cum_7`, `cum_30`, `cum_90`, `cum_ytd`, `ma_20`, `ma_50`, `ma_200`, `ma_20_signal`, `ma_50_signal`, `ma_200_signal`, `rsi`, `macd_line`, `macd_signal`, `macd_hist`, `bb_middle`, `bb_up`, `bb_low`, `volume_spike`, `gap_up`, `gap_down`, `sudden_price_movement`, `volatility_30`, `volatility_60`, `beta`, `var_95`, `var_99`, `drawdown`, `max_drawdown`, `sharpe`, `relative_strength` |
| `benchmark_processed.csv`            | Same pipeline applied to the benchmark index  | Same schema                                                                                                                                                                                                                                                                                                 |
| `<TICKER>_fundamental_processed.csv` | Cleaned quarterly fundamental data            | `date`, `ticker`, `revenue`, `gross_profit`, `operating_profit`, `net_income`, `eps`, `total_assets`, `total_liabilities`, `equity`, `total_debt`, `operating_cash_flow`, `capital_expenditure`, `interest_expense`, `tax_rate`, `receivables`, `inventory`, `payable`, `current_assets`, `current_liabilities`, `COGS`, `roe`, `roa`, `pe`, `pb`, `shares_outstanding`, `market_cap`, `risk_free_rate`, `market_risk_premium`, `gross_profit_margin`, `revenue_growth`, `net_profit_margin`, `receivable_turnover`, `day_sales_outstanding`, `inventory_turnover`, `day_inventory_turnover`, `payable_turnover`, `day_payable_outstanding`, `cash_conversion_cycle`, `current_ratio`, `debt_to_equity`, `interest_coverage`, `fcff`, `fcfe`, `dcf_intrinsic_price`, `dcf_upside`, `dcf_invalid_reason`, `dcf_is_invalid` (all-null columns auto-dropped)                                                                |
| `macro_processed.csv`                | Wide-format macro indicators, daily frequency | `date`, `imf_global_growth`, `fed_funds_rate`, `oil_price`, `us_gdp_growth`, `us_interest_rate`, `us_fx_rate`, `us_fdi_inflow`, `us_cpi`, `us_unemployment`, `vn_gdp_growth`, `vn_interest_rate`, `vn_fx_rate`, `vn_fdi_inflow`, `vn_cpi`, `vn_unemployment`                                                                                                                                                                                                |
| `industry_processed.csv`             | Peer-averaged fundamental metrics             | `date`, `pe_1y`, `pe_5y`, `pb_1y`, `pb_5y`, `pe_industry`, `pb_industry` (all-null columns auto-dropped)                                                                                                                                                                                                                                                                                           |
