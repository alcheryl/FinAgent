...
| `macro_processed.csv`                | Wide-format macro indicators, daily frequency | `date`, `imf_global_growth`, `fed_funds_rate`, `oil_price`, `us_gdp_growth`, `us_interest_rate`, `us_fx_rate`, `us_fdi_inflow`, `us_cpi`, `vn_gdp_growth`, `vn_interest_rate`, `vn_fx_rate`, `vn_fdi_inflow`, `vn_cpi`, `vn_unemployment`                                                                                                                                                                                                |
